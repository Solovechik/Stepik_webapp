...
sudo mysql -uroot -e "create user 'django_db_user'@'localhost' identified by 'mydjangopassword'"
sudo mysql -uroot -e "grant all on stepik_webapp.* to 'django_db_user'@'localhost'"
source ~/web/ask/venv/bin/activate
